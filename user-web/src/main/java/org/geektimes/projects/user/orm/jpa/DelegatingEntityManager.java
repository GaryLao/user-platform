...
public class DelegatingEntityManager implements EntityManager {
    ...
    //lzm comodify 2021-03-12 03:24:12
    //private EntityManager entityManager;  //EntityManager非线程安全
    private EntityManagerFactory entityManagerFactory;  //EntityManagerFactory是线程安全的
    ...
    public void init() {
        ...
        //this.entityManager = entityManagerFactory.createEntityManager();  //EntityManager非线程安全
    }
...
//    }
    ...
    // Setter 方法会被 Tomcat JNDI 实现调用（在Lookup的时候进行调用）
